...
describe('Single element tests', () => {
  ...
  it("half", async () => {
    const input = h(null, h("p", "Lorem ipsum dolor sit amet, consectetur adipiscing elit."));
    const output = await rehype()
      .use(rehypeTextAutospace)
      .run(input);
    const expected = h(null,
...
describe('Left hand side sibling', () => {
  ...
  it("half", async () => {
    const input = h(null, h("p", [h('a', 'link'), "Lorem ipsum dolor sit amet, consectetur adipiscing elit."]));
    const output = await rehype()
      .use(rehypeTextAutospace)
      .run(input);
    const expected = h(null,
...
describe('Right hand side sibling', () => {
  ...
  it("half", async () => {
    const input = h(null, h("p", ["Lorem ipsum dolor sit amet, consectetur adipiscing elit.", h('a', 'link'),]));
    const output = await rehype()
      .use(rehypeTextAutospace)
      .run(input);
    const expected = h(null,
...
describe('Left and right hand side siblings', () => {
  it("full, half", async () => {
    const input = h(null, h("p", h('a', 'link1'), 'あいうえお', h('a', 'link2')));
    const output = await rehype()
      .use(rehypeTextAutospace)
      .run(input);
    const expected = h(null,
